...
class ServiceProvided extends Base
{
    ...
    get protocol() {
        if (this.definition.protocol) {
            return this.definition.protocol.toLowerCase();
        }
        return null;
    }

    get networkProtocol() {
        if (this.definition.networkProtocol) {
            return this.definition.networkProtocol.toLowerCase();
        }
        return null;
    }
    ...
    get path() {
        return Base.parseBool(this.definition.path);
    }
