...
class LocalDeployer
{
    constructor(logger, configRegistry, docker, screen, shell)
    {
        ...
        this._repoStore.setupRepository('local_endpoints_public', 'LOCAL PUBLIC ENDPOINTS');
        this._repoStore.setupRepository('local_endpoints_internal', 'LOCAL INTERNAL ENDPOINTS');
        this._repoStore.setupRepository('local_priority_endpoints_public', 'LOCAL PRIORITY PUBLIC ENDPOINTS');
        this._repoStore.setupRepository('local_priority_endpoints_internal', 'LOCAL PRIORITY INTERNAL ENDPOINTS');
        this._repoStore.setupRepository('local_final_endpoints_public', 'LOCAL FINAL PUBLIC ENDPOINTS');
        this._repoStore.setupRepository('local_final_endpoints_internal', 'LOCAL FINAL INTERNAL ENDPOINTS');
        this._repoStore.setupRepository('local_cluster_dependencies', 'LOCAL CLUSTER DEPENDENCIES');
        this._repoStore.setupRepository('local_consumer_meta', 'LOCAL CONSUMER META');
        this._repoStore.setupRepository('local_provider_meta', 'LOCAL PROVIDER META');
