...
class LocalDeployer
{
    constructor(logger, configRegistry, docker, screen, shell, environment)
    {
    ...
    _processCluster(clusterName, action, dirtyInfo)
    {
        ...
        return Promise.resolve()
            ...
            .then(registry => {
                ...
                var processor = new LocalProcessor(this._logger.sublogger('LocalProc'), this._repoStore, this._docker, this._screen, this._shell, this._environment);
