...
class BerliozClient
{
    ...
    //////////////////////////////////////
    postInternal(region, path, data)
    {
        return this._requestToRegion(region, 'POST', SECTION_INTERNAL, path, data);
    }

    getInternal(region, path)
    {
        return this._requestToRegion(region, 'GET', SECTION_INTERNAL, path);
    }
