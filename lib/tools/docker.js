...
class Docker
{
    constructor(logger, screen, shell)
    {
        ...
        this._docker = new DockerLib(this.dockerConnectOptions);
    }
    ...
    _getHostConfig()
    {
        if (process.env.DOCKER_HOST) {
            ...
            this._dockerConnectOptions.protocol = _.replace(url.protocol, ':', '');
            ...
            this._dockerConnectOptions.protocol = 'tcp';
        ...
        if (this._dockerConnectOptions) {
            if (this._dockerConnectOptions.host) {
                var protocol = this._dockerConnectOptions.protocol;
                var commandHostUrl = protocol + '://' + this._dockerConnectOptions.host;
